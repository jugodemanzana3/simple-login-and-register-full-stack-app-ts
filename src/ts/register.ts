...
const handleFormSubmit = (e: Event) => {
  ...
  const registerPasswordLabel = document.querySelector("#password-label") as HTMLElement
  ...
  if (validatePasswordLength(passwordInput.value, errorMessage, registerPasswordLabel, passwordInput)) return
