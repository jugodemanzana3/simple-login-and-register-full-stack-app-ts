            ...
            return (
              t.forEach((t, s) => {
                ...
                if ("" === a.value) {
                  const t = e[s],
                    c = n[s];
                  i(c, a, r.UU.requiredField, !1, t, !1), (o = !0);
                } else {
                  const t = e[s],
                    r = n[s];
                  c(r, a, t);
  ...
  (0, r.nr)(s.Nb.myAccount),
    ...
    u.addEventListener("submit", (e) => {
      ...
      const t = document.querySelectorAll(s.ZM.label),
        ...
        a = document.querySelector(s.ZM.emailInput),
        c = document.querySelector(s.ZM.passwordInput),
        l = document.querySelectorAll(s.ZM.errorMessage),
        u = a.value.trim(),
        d = c.value.trim(),
        f = t[0],
        p = t[1],
      ...
      (0, o.Sp)(l, n, t, h),
        (0, o.C1)(t, n, l) ||
          ...
          (async () => {
            ...
            const n = JSON.stringify({ email: u, password: d });
            try {
              const o = await r.FH.post("/api/auth/login", n);
              ...
              if ((0, i.F0)(t) && t.response) {
                ...
                e.classList.remove(s.lJ.loading),
                  n.includes("cuenta")
                    ? (0, o.Us)(h, a, n, !0, f, !0)
                    : n.includes("Contraseña") && (0, o.Us)(h, c, n, !0, p, !0);
              }
            }
          })();
    });
