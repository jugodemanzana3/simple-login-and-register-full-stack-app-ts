...
const verifyToken = async (page) => {
    try {
        ...
        if ((0,axios__WEBPACK_IMPORTED_MODULE_3__.isAxiosError)(e)) {
            if (e.response) {
...
(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.verifyToken)(_constants__WEBPACK_IMPORTED_MODULE_3__.PAGES.myAccount);
const handleFormSubmit = (e) => {
    ...
    const dataFetching = async () => {
        ...
        const alertMessage = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.alerMessage);
        ...
        try {
            ...
            if ((0,axios__WEBPACK_IMPORTED_MODULE_4__.isAxiosError)(e)) {
                if (e.response) {
                    console.error(e.response.data);
