...
(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.verifyAuth)("my-account");
...
const handleFormSubmit = (e) => {
    ...
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateInputs)(labels, inputs, errorMessages))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(emailValue, emailError, emailInput, emailLabel))
        return;
    const dataFetching = async () => {
        ...
        try {
            const res = await _utils_utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/api/auth/login", formData);
            ...
            if (message.includes("cuenta")) {
                (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.addFieldError)(globalError, emailInput, message, true, emailLabel, true);
            }
            else if (message.includes("Contraseña")) {
                (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.addFieldError)(globalError, passwordInput, message, true, passwordLabel, true);
            }
        }
    };
    dataFetching();
