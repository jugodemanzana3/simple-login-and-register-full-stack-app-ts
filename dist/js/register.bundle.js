(() => {
  ...
  var e = {
      ...
      216: (e, t, n) => {
        n.d(t, { C1: () => s, DT: () => o, Sp: () => c, Us: () => a, eX: () => i });
        var r = n(357);
        const o = (e, t, n, o) => !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e) && (a(t, n, r.UU.invalidMail, !0, o, !0), !0),
          s = (e, t, n) => {
            let o = !1;
            return (
              t.forEach((t, s) => {
          ...
          i = (e, t, n, o) => e.length < 8 && (a(t, n, r.UU.invalidPasswordLength, !0, o, !0), !0),
          a = (e, t, n, o, s, i) => {
      ...
      179: (e, t, n) => {
        ...
        const a = r.A.create({
          ...
          c = (e, t) => {
            (e.textContent = t),
              e.classList.add(i.lJ.visible),
              setTimeout(() => {
                e.classList.remove(i.lJ.visible);
              }, 3e3);
          },
          l = (e) => {
            setTimeout(() => {
          ...
          u = async (e) => {
            try {
              const t = await a.get("/api/auth/verify");
              return (window.location.href = `./${e}.html`), t.data;
            } catch (e) {
              (0, o.F0)(e) && e.response && console.error(e.response.data);
            }
          };
      },
      110: (e, t, n) => {
      ...
      83: (e, t, n) => {
        ...
        const l = (e) => ((e = e.toLowerCase()), (t) => a(t) === e),
          ...
          O = l("FileList"),
          R = l("URLSearchParams"),
          [v, T, A, C] = ["ReadableStream", "Request", "Response", "Headers"].map(l);
            ...
            "undefined" != typeof globalThis
              ...
              : "undefined" != typeof self
                ...
                : "undefined" != typeof window
                  ...
                  : global,
          j = (e) => !f(e) && e !== L,
          P = ((U = "undefined" != typeof Uint8Array && i(Uint8Array)), (e) => U && e instanceof U);
        var U;
        const F = l("HTMLFormElement"),
          ...
          q = "0123456789",
          M = { DIGIT: q, ALPHA: k, ALPHA_DIGIT: k + k.toUpperCase() + q },
          I = l("AsyncFunction"),
          J =
              ...
              : z
                ? ((W = `axios@${Math.random()}`),
                  ...
                  L.addEventListener(
                    "message",
                    ({ source: e, data: t }) => {
                      e === L && t === W && K.length && K.shift()();
                    },
                    !1
                  ),
                  (e) => {
                    K.push(e), L.postMessage(W, "*");
                  })
                : (e) => setTimeout(e));
        var H, z, W, K;
        const V =
        ...
        const ne = $.toFlatObject($, {}, null, function (e) {
          ...
          re = function (e, t, n) {
            ...
            function c(e) {
              ...
              if (!a && $.isBlob(e)) throw new Q("Blob is not supported. Use a Buffer instead.");
                ...
                if ($.endsWith(n, "{}")) (n = r ? n : n.slice(0, -2)), (e = JSON.stringify(e));
                  ...
                  return (
                    ...
                    a.forEach(function (e, r) {
                      !$.isUndefined(e) &&
                        null !== e &&
                        t.append(!0 === i ? te([n], r, s) : null === i ? n : n + "[]", c(e));
                    }),
                    !1
                  );
            ...
            const u = [],
              d = Object.assign(ne, { defaultVisitor: l, convertValue: c, isVisitable: Y });
                ...
                if (!$.isUndefined(n)) {
                  ...
                  u.push(n),
                    $.forEach(n, function (n, s) {
                      !0 === (!($.isUndefined(n) || null === n) && o.call(t, n, $.isString(s) ? s.trim() : s, r, d)) &&
                        e(n, r ? r.concat(s) : [s]);
                    }),
                    u.pop();
                }
        ...
        function le(e, t, n) {
          ...
          const r = (n && n.encode) || ce,
            o = n && n.serialize;
          let s;
          if (((s = o ? o(t, n) : $.isURLSearchParams(t) ? t.toString() : new ae(t, n).toString(r)), s)) {
            const t = e.indexOf("#");
              ...
              function (e, t) {
                ...
                if (o) {
                  ...
                  if ((s = $.isFileList(e)) || n.indexOf("multipart/form-data") > -1) {
                    ...
                    return re(s ? { "files[]": e } : e, t && new t(), this.formSerializer);
                  }
                }
                return o || r
        ...
        function Te(e) {
          return !1 === e || null == e ? e : $.isArray(e) ? e.map(Te) : String(e);
        }
        function Ae(e, t, n, r, o) {
          return $.isFunction(r)
            ? r.call(this, t, n)
            : (o && (t = n),
              $.isString(t) ? ($.isString(r) ? -1 !== t.indexOf(r) : $.isRegExp(r) ? r.test(t) : void 0) : void 0);
        }
        class Ce {
          constructor(e) {
            e && this.set(e);
          ...
          set(e, t, n) {
            ...
            function o(e, t, n) {
              ...
              const s = $.findKey(r, o);
              (!s || void 0 === r[s] || !0 === n || (void 0 === n && !1 !== r[s])) && (r[s || t] = Te(e));
            }
            ...
            else if ($.isHeaders(e)) for (const [t, r] of e.entries()) o(r, t, n);
            else null != e && o(t, e, n);
            return this;
          }
          get(e, t) {
          ...
          normalize(e) {
            ...
            return (
              $.forEach(this, (r, o) => {
                const s = $.findKey(n, o);
                if (s) return (t[s] = Te(r)), void delete t[o];
                const i = e
                  ? (function (e) {
                      return e
                        .trim()
        ...
        Ce.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]),
          $.reduceDescriptors(Ce.prototype, ({ value: e }, t) => {
        ...
        const Fe = (e, t, n = 3) => {
          ...
          ke = ge.hasStandardBrowserEnv
            ? {
                write(e, t, n, r, o, s) {
                  const i = [e + "=" + encodeURIComponent(t)];
                  $.isNumber(n) && i.push("expires=" + new Date(n).toGMTString()),
                    $.isString(r) && i.push("path=" + r),
                    $.isString(o) && i.push("domain=" + o),
                    !0 === s && i.push("secure"),
        ...
        const Me = (e) => (e instanceof xe ? { ...e } : e);
        function Ie(e, t) {
          t = t || {};
          const n = {};
          function r(e, t, n) {
        ...
        const Je = (e) => {
            ...
            if (
              ((t.headers = a = xe.from(a)),
              (t.url = le(qe(t.baseURL, t.url), e.params, e.paramsSerializer)),
              c &&
                a.set(
                  "Authorization",
                  "Basic " +
              ...
              if (ge.hasStandardBrowserEnv || ge.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0);
            ...
            if (ge.hasStandardBrowserEnv && (o && $.isFunction(o) && (o = o(t)), o || (!1 !== o && De(t.url)))) {
          ...
          He =
            ...
            function (e) {
              return new Promise(function (t, n) {
                const r = Je(e);
                let o = r.data;
                const s = xe.from(r.headers).normalize();
                let i,
                  a,
                  c,
                  l,
                ...
                function y() {
                  if (!m) return;
                  const r = xe.from("getAllResponseHeaders" in m && m.getAllResponseHeaders());
                  Ue(
                    function (e) {
                      t(e), h();
                    },
                ...
                m.open(r.method.toUpperCase(), r.url, !0),
                  ...
                  (m.ontimeout = function () {
                    ...
                    r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
                      n(new Q(t, o.clarifyTimeoutError ? Q.ETIMEDOUT : Q.ECONNABORTED, e, m)),
                      (m = null);
                  }),
                  ...
                  p && (([c, u] = Fe(p, !0)), m.addEventListener("progress", c)),
                  f &&
                    m.upload &&
                    (([a, l] = Fe(f)),
            ...
            if (t || n) {
              ...
              const o = function (e) {
                if (!n) {
                  ...
                  r.abort(t instanceof Q ? t : new Pe(t instanceof Error ? t.message : t));
                }
              };
              let s =
                t &&
          ...
          $e = Ve && "function" == typeof ReadableStream,
          Ze =
            Ve &&
        ...
        const Xe = (e, ...t) => {
          ...
          Ye = $e && Xe(() => $.isReadableStream(new Response("").body)),
          et = { stream: Ye && ((e) => e.body) };
        var tt;
        Ve &&
          ((tt = new Response()),
          ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
            !et[e] &&
              (et[e] = $.isFunction(tt[e])
                ? (t) => t[e]()
                : (t, n) => {
            ...
            (async (e) => {
              ...
              try {
                if (
                        ...
                        ? (async (e) => {
                            ...
                            return $.isArrayBufferView(e) || $.isArrayBuffer(e)
                              ...
                              : ($.isURLSearchParams(e) && (e += ""),
                                $.isString(e) ? (await Ze(e)).byteLength : void 0);
                          })(t)
                        : n;
                    })(u, r))
                ) {
                  ...
                  if (($.isFormData(r) && (e = n.headers.get("content-type")) && u.setContentType(e), n.body)) {
                    const [e, t] = _e(y, Fe(Be(c)));
                ...
                let s = await fetch(p);
                const i = Ye && ("stream" === l || "response" === l);
                if (Ye && (a || (i && m))) {
                  const e = {};
                  ["status", "statusText", "headers"].forEach((t) => {
                    e[t] = s[t];
                  });
                  const t = $.toFiniteNumber(s.headers.get("content-length")),
                    [n, r] = (a && _e(t, Fe(Be(a), !0))) || [];
                  s = new Response(
                    Ke(s.body, 65536, n, () => {
                      r && r(), m && m();
                    }),
                ...
                l = l || "text";
                let b = await et[$.findKey(et, l) || "text"](s, e);
                return (
                  !i && m && m(),
                  await new Promise((t, n) => {
                    Ue(t, n, {
                      data: b,
                      headers: xe.from(s.headers),
                      status: s.status,
                ...
                if ((m && m(), t && "TypeError" === t.name && /fetch/i.test(t.message)))
                  throw Object.assign(new Q("Network Error", Q.ERR_NETWORK, e, p), { cause: t.cause || t });
                throw Q.from(t, t && t.code, e, p);
              }
            }),
        };
        $.forEach(nt, (e, t) => {
        ...
        const rt = (e) => `- ${e}`,
          ...
          st = (e) => {
            ...
            for (let s = 0; s < t; s++) {
              let t;
              if (((n = e[s]), (r = n), !ot(n) && ((r = nt[(t = String(n)).toLowerCase()]), void 0 === r)))
        ...
        function at(e) {
          return (
            ...
            st(e.adapter || Se.adapter)(e).then(
              function (t) {
                return it(e), (t.data = Ne.call(e, e.transformResponse, t)), (t.headers = xe.from(t.headers)), t;
              },
              function (t) {
                return (
                  Le(t) ||
                    ...
                    t &&
                      t.response &&
                      ((t.response.data = Ne.call(e, e.transformResponse, t.response)),
        ...
        class ft {
            ...
            void 0 !== n &&
              ...
              null != r &&
                ($.isFunction(r)
                  ...
                  : ut.assertOptions(r, { encode: dt.function, serialize: dt.function }, !0)),
          ...
          getUri(e) {
            return le(qe((e = Ie(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
          }
        }
        ...
        const bt = yt,
          gt = (function e(t) {
            const n = new pt(t),
              r = o(pt.prototype.request, n);
            return (
              $.extend(r, pt.prototype, n, { allOwnKeys: !0 }),
        ...
        (gt.Axios = pt),
          ...
          (gt.mergeConfig = Ie),
          (gt.AxiosHeaders = xe),
          (gt.formToJSON = (e) => we($.isHTMLForm(e) ? new FormData(e) : e)),
          (gt.getAdapter = st),
          (gt.HttpStatusCode = bt),
          (gt.default = gt);
        const wt = gt;
      },
    },
  ...
  var r = n(179),
    ...
    s = n(357),
    i = n(110);
  const a = document.querySelector(s.ZM.passwordInput),
    c = document.querySelector(s.ZM.eyeIcon),
    l = document.querySelector(s.ZM.eyeOffIcon),
    u = document.querySelector(s.ZM.form);
  (0, r.nr)(s.Nb.myAccount),
    c.addEventListener("click", () =>
      ((e, t, n) => {
        (e.type = "text"), t.classList.remove(s.lJ.visible), n.classList.add(s.lJ.visible);
      })(a, c, l)
    ),
    l.addEventListener("click", () =>
      ((e, t, n) => {
        (e.type = "password"), t.classList.add(s.lJ.visible), n.classList.remove(s.lJ.visible);
      })(a, c, l)
    ),
    u.addEventListener("submit", (e) => {
      ...
      const t = document.querySelectorAll(s.ZM.label),
        ...
        a = document.querySelector(s.ZM.nameInput),
        c = document.querySelector(s.ZM.emailInput),
        l = document.querySelector(s.ZM.passwordInput),
        u = document.querySelectorAll(s.ZM.errorMessage),
        d = a.value.trim(),
        f = c.value.trim(),
        p = t[1],
        h = l.value.trim(),
        ...
        (0, o.C1)(t, n, u) ||
          ...
          (async () => {
            const e = document.querySelector(s.ZM.submitButton),
              t = document.querySelector(s.ZM.alerMessage);
            e.classList.add(s.lJ.loading);
            const n = JSON.stringify({ name: d, email: f, password: h });
            try {
              const o = await r.FH.post("/api/auth/register", n);
              e.classList.remove(s.lJ.loading), (0, r.S7)(t, o.data.message), (0, r.fs)(s.Nb.myAccount);
            } catch (t) {
              if ((0, i.F0)(t) && t.response) {
                console.error(t.response.data);
                const n = t.response.data.message;
                e.classList.remove(s.lJ.loading), (0, o.Us)(y, c, n, !0, p, !0);
              }
            }
          })();
    });
