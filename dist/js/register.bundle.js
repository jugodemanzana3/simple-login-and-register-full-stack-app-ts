...
const handleFormSubmit = (e) => {
    ...
    const passwordInput = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.passwordInput);
    const errorMessages = document.querySelectorAll(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.alerMessage);
    ...
    const dataFetching = async () => {
        ...
        try {
            ...
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)("my-account");
        }
        catch (e) {
