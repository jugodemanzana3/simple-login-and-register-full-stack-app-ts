(() => {
  ...
  var e = {
      ...
      216: (e, t, n) => {
        n.d(t, { DT: () => o, Sp: () => a, TT: () => s, Us: () => i });
        var r = n(357);
        const o = (e, t, n, o) => !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e) && (i(t, n, r.UU.invalidMail, !0, o, !0), !0),
          s = (e, t, n, o) => "" === e && (i(t, n, r.UU.requiredField, !1, o, !1), !0),
          i = (e, t, n, o, s, i) => {
      ...
      83: (e, t, n) => {
        ...
        const l = (e) => ((e = e.toLowerCase()), (t) => a(t) === e),
          ...
          O = l("FileList"),
          R = l("URLSearchParams"),
          [T, v, A, C] = ["ReadableStream", "Request", "Response", "Headers"].map(l);
            ...
            "undefined" != typeof globalThis
              ...
              : "undefined" != typeof self
                ...
                : "undefined" != typeof window
                  ...
                  : global,
          P = (e) => !d(e) && e !== j,
          L = ((U = "undefined" != typeof Uint8Array && i(Uint8Array)), (e) => U && e instanceof U);
        var U;
              ...
              : z
                ? ((W = `axios@${Math.random()}`),
                  ...
                  j.addEventListener(
                    "message",
                    ({ source: e, data: t }) => {
                      e === j && t === W && K.length && K.shift()();
                    },
                    !1
                  ),
                  (e) => {
                    K.push(e), j.postMessage(W, "*");
                  })
                : (e) => setTimeout(e));
        var J, z, W, K;
        const V =
        ...
        const ne = $.toFlatObject($, {}, null, function (e) {
          ...
          re = function (e, t, n) {
            ...
            const u = [],
              f = Object.assign(ne, { defaultVisitor: l, convertValue: c, isVisitable: Y });
                ...
                if (!$.isUndefined(n)) {
                  ...
                  u.push(n),
                    $.forEach(n, function (n, s) {
                      !0 === (!($.isUndefined(n) || null === n) && o.call(t, n, $.isString(s) ? s.trim() : s, r, f)) &&
                        e(n, r ? r.concat(s) : [s]);
                    }),
                    u.pop();
                }
        ...
        function ve(e) {
          return !1 === e || null == e ? e : $.isArray(e) ? e.map(ve) : String(e);
        }
        ...
        class Ce {
          ...
          set(e, t, n) {
            ...
            function o(e, t, n) {
              ...
              const s = $.findKey(r, o);
              (!s || void 0 === r[s] || !0 === n || (void 0 === n && !1 !== r[s])) && (r[s || t] = ve(e));
            }
          ...
          normalize(e) {
            ...
            return (
              $.forEach(this, (r, o) => {
                const s = $.findKey(n, o);
                if (s) return (t[s] = ve(r)), void delete t[o];
                const i = e
                  ? (function (e) {
                      return e
                        .trim()
              ...
              return new Promise(function (t, n) {
                ...
                m.open(r.method.toUpperCase(), r.url, !0),
                  ...
                  (r.cancelToken || r.signal) &&
                    ((i = (t) => {
                      m && (n(!t || t.type ? new Le(null, e, m) : t), m.abort(), (m = null));
                    }),
            ...
            if (t || n) {
              ...
              const o = function (e) {
                if (!n) {
                  ...
                  r.abort(t instanceof Q ? t : new Le(t instanceof Error ? t.message : t));
                }
              };
              let s =
                t &&
        ...
        class dt {
          ...
          _request(e, t) {
            ...
            void 0 !== n &&
              ...
              null != r &&
                ($.isFunction(r)
                  ...
                  : ut.assertOptions(r, { encode: ft.function, serialize: ft.function }, !0)),
            ...
            if (!a) {
              ...
              for (e.unshift.apply(e, i), e.push.apply(e, c), u = e.length, l = Promise.resolve(t); f < u; )
                l = l.then(e[f++], e[f++]);
              return l;
            }
            u = i.length;
  ...
  var r = n(110),
    ...
    s = n(216),
    i = n(357);
  const a = document.querySelector(i.ZM.form);
  (0, o.nr)(i.Nb.myAccount),
    a.addEventListener("submit", (e) => {
      e.preventDefault();
      const t = document.querySelectorAll(i.ZM.label),
        n = document.querySelectorAll(i.ZM.input),
        a = document.querySelector(i.ZM.alerMessage),
        c = document.querySelector(i.ZM.emailInput),
        l = document.querySelector(i.ZM.emailLabel),
        u = document.querySelectorAll(i.ZM.errorMessage),
        f = c.value.trim(),
        d = u[0],
        p = u[1];
      (0, s.Sp)(u, n, t, p),
        (0, s.TT)(f, d, c, l) ||
          (0, s.DT)(f, p, c, l) ||
          (async () => {
            const e = document.querySelector(i.ZM.submitButton);
            e.classList.add(i.lJ.loading);
            const t = JSON.stringify({ email: f });
            try {
              const n = await o.FH.post("/api/auth/forgot-password", t);
              e.classList.remove(i.lJ.loading), (0, o.S7)(a, n.data.message), (c.value = ""), (0, o.fs)(i.Nb.login);
            } catch (t) {
              if ((0, r.F0)(t))
                if (t.response) {
                  console.error(t.response.data);
                  const n = t.response.data.message;
                  e.classList.remove(i.lJ.loading), (0, s.Us)(p, c, n, !0, l, !0);
                } else "Network Error" === t.message && console.error("Error de red");
            }
          })();
    });
})();
