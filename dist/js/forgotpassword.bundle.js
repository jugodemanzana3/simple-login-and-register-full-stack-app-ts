...
const handleFormSubmit = (e) => {
    ...
    const dataFetching = async () => {
        ...
        try {
            ...
            emailInput.value = "";
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)("./login.html");
        }
        catch (e) {
            console.error(e.response.data);
            const message = e.response.data.message;
            submitButton.classList.remove("loading");
            (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.addFieldError)(emailError, emailInput, message, true, emailLabel, true);
        }
    };
    dataFetching();
};
