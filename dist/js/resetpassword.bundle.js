...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (config[env]);
...
const api = axios__WEBPACK_IMPORTED_MODULE_1__["default"].create({
    baseURL: `${_config__WEBPACK_IMPORTED_MODULE_0__["default"].SERVER_URL}`,
    headers: {
...
const handleFormSubmit = (e) => {
    ...
    const passwordError = errorMessages[0];
    ...
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateInputs)(labels, inputs, errorMessages))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.confirmPasswordMatch)(passwordValue, confirmPasswordValue, errorMessage, confirmPasswordInput, confirmPasswordLabel))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validatePasswordLength)(passwordValue, errorMessage, passwordInput, passwordLabel))
        return;
    const dataFetching = async () => {
        ...
        try {
            const res = await _utils_utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/api/auth/reset-password", formData, {
                headers: {
            ...
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)("./my-account.html");
        }
        catch (e) {
            console.error(e.response.data);
            const message = e.response.data.message;
            submitButton.classList.remove("loading");
            (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.addFieldError)(passwordError, passwordInput, message, true, passwordLabel, true);
        }
    };
    dataFetching();
};
