...
const fetchData = async (page) => {
    ...
    const data = await (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.getUserData)(page);
    if (data) {
        userName.textContent = data.name;
    }
};
fetchData(_constants__WEBPACK_IMPORTED_MODULE_1__.PAGES.login);
const handleLogoutButton = () => {
    const logout = async () => {
        const alertMessage = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_1__.SELECTORS.alerMessage);
        try {
            ...
            if ((0,axios__WEBPACK_IMPORTED_MODULE_2__.isAxiosError)(e)) {
                if (e.response) {
                    console.error(e.response.data);
                }
            }
