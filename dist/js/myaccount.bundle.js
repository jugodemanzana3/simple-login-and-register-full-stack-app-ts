(() => {
  ...
  var e = {
      ...
      357: (e, t, n) => {
        n.d(t, { Nb: () => r, ZM: () => s, lJ: () => o });
        const r = { myAccount: "my-account", login: "login", forgotPassword: "forgot-password" },
          o = { loading: "loading", visible: "visible" },
          s = {
      ...
      179: (e, t, n) => {
        ...
        const a = r.A.create({
          ...
          l = async (e) => {
            try {
              return (await a.get("/api/auth/verify")).data;
            } catch (t) {
              (0, o.F0)(t) && t.response && (console.error(t.response.data), (window.location.href = `./${e}.html`));
            }
          };
      },
      110: (e, t, n) => {
      ...
      83: (e, t, n) => {
        ...
        const u = (e) => ((e = e.toLowerCase()), (t) => a(t) === e),
          ...
          S = u("FileList"),
          R = u("URLSearchParams"),
          [T, A, v, x] = ["ReadableStream", "Request", "Response", "Headers"].map(u);
            ...
            "undefined" != typeof globalThis
              ...
              : "undefined" != typeof self
                ...
                : "undefined" != typeof window
                  ...
                  : global,
          P = (e) => !d(e) && e !== j,
          L = ((F = "undefined" != typeof Uint8Array && i(Uint8Array)), (e) => F && e instanceof F);
        var F;
        ...
        const ne = $.toFlatObject($, {}, null, function (e) {
          ...
          re = function (e, t, n) {
            ...
            const l = [],
              f = Object.assign(ne, { defaultVisitor: u, convertValue: c, isVisitable: Y });
        ...
        function Ae(e) {
          return !1 === e || null == e ? e : $.isArray(e) ? e.map(Ae) : String(e);
        }
        ...
        xe.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]),
          $.reduceDescriptors(xe.prototype, ({ value: e }, t) => {
        ...
        const He = (e) => {
            ...
            if (
              ((t.headers = a = Ce.from(a)),
              (t.url = ue(qe(t.baseURL, t.url), e.params, e.paramsSerializer)),
              c &&
                a.set(
                  "Authorization",
                  "Basic " +
          ...
          ze =
            ...
            function (e) {
              return new Promise(function (t, n) {
                const r = He(e);
                let o = r.data;
                const s = Ce.from(r.headers).normalize();
                let i,
                  a,
                  c,
                  u,
        ...
        const Ze = (e, ...t) => {
          ...
          Ye = $e && Ze(() => $.isReadableStream(new Response("").body)),
            ...
            (async (e) => {
              ...
              try {
                if (
                        ...
                        ? (async (e) => {
                            ...
                            return $.isArrayBufferView(e) || $.isArrayBuffer(e)
                              ...
                              : ($.isURLSearchParams(e) && (e += ""),
                                $.isString(e) ? (await Ge(e)).byteLength : void 0);
                          })(t)
                        : n;
                    })(l, r))
                ) {
                  ...
                  if (($.isFormData(r) && (e = n.headers.get("content-type")) && l.setContentType(e), n.body)) {
                    const [e, t] = Be(y, _e(Ue(c)));
                ...
                u = u || "text";
                let b = await et[$.findKey(et, u) || "text"](s, e);
                return (
                  !i && m && m(),
                  await new Promise((t, n) => {
                    Fe(t, n, {
                      data: b,
                      headers: Ce.from(s.headers),
                      status: s.status,
        ...
        function at(e) {
          return (
            ...
            st(e.adapter || Oe.adapter)(e).then(
              function (t) {
                return it(e), (t.data = Ne.call(e, e.transformResponse, t)), (t.headers = Ce.from(t.headers)), t;
              },
              function (t) {
                return (
                  je(t) ||
        ...
        class dt {
          constructor(e) {
            (this.defaults = e), (this.interceptors = { request: new le(), response: new le() });
          }
          async request(e, t) {
            try {
          ...
          _request(e, t) {
            "string" == typeof e ? ((t = t || {}).url = e) : (t = e || {}), (t = Me(this.defaults, t));
            ...
            void 0 !== n &&
              ...
              null != r &&
                ($.isFunction(r)
                  ...
                  : lt.assertOptions(r, { encode: ft.function, serialize: ft.function }, !0)),
          ...
          getUri(e) {
            return ue(qe((e = Me(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
          }
        }
        $.forEach(["delete", "get", "head", "options"], function (e) {
          dt.prototype[e] = function (t, n) {
            return this.request(Me(n || {}, { method: e, url: t, data: (n || {}).data }));
          };
        }),
  ...
  var r = n(179),
    o = n(357),
    s = n(110);
  const i = document.querySelector(o.ZM.logoutButton);
  (async (e) => {
    const t = document.querySelector(o.ZM.userName),
      n = await (0, r.gL)(e);
    n && (t.textContent = n.name);
  })(o.Nb.login),
    i.addEventListener("click", () => {
      (async () => {
        const e = document.querySelector(o.ZM.alerMessage);
        try {
          const t = await r.FH.post("/api/auth/logout");
          (0, r.S7)(e, t.data.message), (0, r.fs)(o.Nb.login);
        } catch (e) {
          (0, s.F0)(e) && e.response && console.error(e.response.data);
        }
      })();
    });
})();
